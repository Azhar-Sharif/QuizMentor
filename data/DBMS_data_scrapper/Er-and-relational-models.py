...
topic_url = "https://www.geeksforgeeks.org/quizzes/er-and-relational-models-gq/"
...
for i in range(1, 9): 
    ...
    if response.status_code == 200:
        ...
        print(f"Failed to retrieve page {i} for er-and-relational-models. Status code:", response.status_code)

# Save the questions data for the topic to a JSON file
file_name = 'Er-and-relational-models.json'
