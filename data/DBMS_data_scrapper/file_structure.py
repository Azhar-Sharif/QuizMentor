...
topic_url = "https://www.geeksforgeeks.org/quizzes/file-structures-sequential-files-indexing-b-and-b-trees-gq/"
...
for i in range(1, 5): 
    ...
    if response.status_code == 200:
        ...
        print(f"Failed to retrieve page {i} for file_structure. Status code:", response.status_code)

# Save the questions data for the topic to a JSON file
file_name = 'file_structure.json'
