...
topic_url = "https://www.geeksforgeeks.org/quizzes/database-design-normal-forms-gq/"
...
for i in range(1, 11): 
    ...
    if response.status_code == 200:
        ...
        print(f"Failed to retrieve page {i} for Database_Design_(Normal Forms). Status code:", response.status_code)

# Save the questions data for the topic to a JSON file
file_name = 'Database_Design_(Normal Forms).json'
