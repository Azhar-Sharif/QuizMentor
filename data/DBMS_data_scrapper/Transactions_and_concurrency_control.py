...
topic_url = "https://www.geeksforgeeks.org/quizzes/transactions-and-concurrency-control-gq/"
...
for i in range(1, 6): 
    ...
    if response.status_code == 200:
        ...
        print(f"Failed to retrieve page {i} for Transactions_and_concurrency_control. Status code:", response.status_code)

# Save the questions data for the topic to a JSON file
file_name = 'Transactions_and_concurrency_control.json'
