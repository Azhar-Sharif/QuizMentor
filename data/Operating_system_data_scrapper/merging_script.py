...
questions_file = 'unixs.json'  # File with questions, options, and images
answers_file = 'unix_correct_answers.json'    # File with question numbers and correct options
output_file = 'unix_mcqs.json'
import json
